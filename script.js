...
factor[0] = new Array(1, .3048, 9.806650);

property[1] = "Area";
unit[1] = new Array("Square meter (m^2)", "Acre (acre)","Square centimeter", "Square kilometer","Square yard (yd^2)");
factor[1] = new Array(1, 4046.856,.8361274);


property[2] = "Electricity";
unit[2] = new Array("Coulomb (Cb)",  "Ampere hour (A hr)", "Faraday (F)",  "Millifaraday (mF)", "Microfaraday (mu-F)", );
factor[2] = new Array(1,  3600, 96521.8999999997,  96.5219, 9.65219E-02, );

property[3] = "Energy";
unit[3] = new Array("Joule (J)",  "Calorie (SI) (cal)", "Calorie (mean)(cal)", "Calorie (thermo)", "Electron volt (eV)", "Erg (erg)",  "Horsepower-hour", "Kilocalorie (SI)(kcal)", "Kilocalorie (mean)(kcal)", "Kilowatt-hour (kW hr)",  "Watt-hour (W hr)", "Watt-second (W sec)");
factor[3] = new Array(1,  4.1868, 4.19002, 4.184, 1.6021E-19, .0000001,  2684077.3, 4186.8, 4190.02, 3600000,  3600, 1);

property[4] = "Force";
unit[4] = new Array("Newton (N)");
...
property[6] = "Length";
unit[6] = new Array("Meter (m)",  "Centimeter (cm)", "Kilometer (km)",  "Furlong",  "Foot (ft)", "Inch (in)",  "Micrometer (mu-m)", "Mil", "Millimeter (mm)", "Nanometer (nm)", "Mile (int'l nautical)", "Mile (UK nautical)", "Mile (US nautical)",   "Picometer (pm)",  "Yard (yd)");
factor[6] = new Array(1,  .01, 1000,  201.168,  .3048, .0254,  .000001, .0000254, .001, 1E-9, 1852, 1853.184, 1852,   1E-12,  .9144);


property[7] = "Mass";
unit[7] = new Array("Kilogram (kgr)", "Gram (gr)", "Milligram (mgr)", "Microgram (mu-gr)", "Carat (metric)(ct)", "Hundredweight (long)", "Hundredweight (short)", "Pound mass (lbm)", "Pound mass (troy)", "Ounce mass (ozm)", "Ounce mass (troy)", "Slug", "Ton (assay)", "Ton (long)", "Ton (short)", "Ton (metric)", "Tonne");
factor[7] = new Array(1, .001, 1e-6, .000000001, .0002, 50.80235, 45.35924, .4535924, .3732417, .02834952, .03110348, 14.5939, .02916667, 1016.047, 907.1847, 1000, 1000);
...
property[10] = "Time";
unit[10] = new Array("Second (sec)", "Day (mean solar)", "Day (sidereal)", "Hour (mean solar)", "Hour (sidereal)", "Minute (mean solar)", "Minute (sidereal)", "Month (mean calendar)", "Second (sidereal)", "Year (calendar)", "Year (tropical)", "Year (sidereal)");
factor[10] = new Array(1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, .9972696, 31536000, 31556930, 31558150);

property[11] = "Velocity & Speed";
unit[11] = new Array("Meter/second (m/sec)", "Foot/minute (ft/min)", "Foot/second (ft/sec)", "Kilometer/hour (kph)", "Knot (int'l)", "Mile (US)/hour (mph)", "Mile (nautical)/hour", "Mile (US)/minute", "Mile (US)/second", "Speed of light (c)", "Mach (STP)(a)");
factor[11] = new Array(1, 5.08E-03, .3048, .2777778, .5144444, .44707, .514444, 26.8224, 1609.344, 299792458, 340.0068750);




property[12] = "Volume Flow";
unit[12] = new Array("Cubic meter/second", "Cubic foot/second", "Cubic foot/minute", "Cubic inches/minute", "Gallons (US,liq)/minute)");
factor[12] = new Array(1, .02831685, .0004719474, 2.731177E-7, 6.309020E-05);
